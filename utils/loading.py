...
def load_and_filter_jsonl_gz_file_by_chunks(filepath, categ, chunk_size=10000, exclude_fields=None):
    '''
    ...
    with gzip.open(filepath, 'rt', encoding='utf-8') as f:
        ...
        for line in f:
            ...
            if len(records) == chunk_size:
                ...
                df_filtered = df_chunk[df_chunk['categories'] == categ].drop(columns=exclude_fields, errors='ignore')
